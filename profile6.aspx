<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile6.aspx.cs" Inherits="SongCatelogApp.profile6" %>
...
<body onload="loadNewsAwards()">
                                     ...
                                     <div >
                                                <script type="text/javascript" id="myscript">
                                                    (function ($) {
                                                     ...
                                                     <span id="spanNext" runat="server">  <a onclick="loadNextSongsList()" href="javascript:void(0)" style="font-size:16px;font-weight:bold;text-align:center;"><img src="images/next.png" width="150" height="50" /></a></span>
    ...
    <script>
        ...
        function startworking() {
            ...
            var urlload = "profile6.aspx/loadMoreSongs";
            if (loadtype == "all") {
                urlload = "profile6.aspx/loadMoreSongs";
            }
            if (loadtype == "featured") {
                urlload = "profile6.aspx/loadMoreSongsFeatured";
            }
           // console.log(12);
