<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile5_new.aspx.cs" Inherits="SongCatelogApp.profile5" %>
                ...
                <div class="col-sm-9 user-songs">
                                                        ...
                                                        <div role="group" class="ws-sound">
                                                            ...
                                                            <div class="ws-sound__body">
                                                                <div class="ws-sound__artwork" >
                                                                    <a class="ws-sound__coverArt"  data-cover="background-image: url('<%# (System.IO.File.Exists(@"C:\\inetpub\\wwwroot\\Hitlicense\\Profile_SongImage\\" + DataBinder.Eval(Container.DataItem, "id") +".jpg")) ?  "http://testapp.hitlicense.com/Profile_SongImage/"+DataBinder.Eval(Container.DataItem, "id")+".jpg" : ((System.IO.File.Exists(@"C:\\inetpub\\wwwroot\\Hitlicense\\Profile_UserImage\\" + DataBinder.Eval(Container.DataItem, "uploader") +"_user.jpg"))? "http://testapp.hitlicense.com/Profile_UserImage/"+DataBinder.Eval(Container.DataItem, "uploader") +"_user.jpg":"http:/testapp.hitlicense.com/Profile_SongImage/default_cropImg.jpg")  %>');">
                                                                        <span class="ws-image ws-artwork ws-artwork-placeholder">
                                                                            <span style="background-image: url('<%# (System.IO.File.Exists(@"C:\\inetpub\\wwwroot\\Hitlicense\\Profile_SongImage\\" + DataBinder.Eval(Container.DataItem, "id") +".jpg")) ?  "http://testapp.hitlicense.com/Profile_SongImage/"+DataBinder.Eval(Container.DataItem, "id")+".jpg" : ((System.IO.File.Exists(@"C:\\inetpub\\wwwroot\\Hitlicense\\Profile_UserImage\\" + DataBinder.Eval(Container.DataItem, "uploader") +"_user.jpg"))? "http://testapp.hitlicense.com/Profile_UserImage/"+DataBinder.Eval(Container.DataItem, "uploader") +"_user.jpg":"http:/testapp.hitlicense.com/Profile_SongImage/default_cropImg.jpg")  %>');" class="ws-artwork ws-image__thumb"></span>
                                                                        </span>
                                                                    </a>
                                                                </div>
                    ...
                    <div class="most-view-sec" id="videosdiv" runat="server">
                        ...
                        <div class="youtube-videos">
                            ...
                            <div class="carousel slide multi-item-carousel-videos" id="theCarouselVideos">
